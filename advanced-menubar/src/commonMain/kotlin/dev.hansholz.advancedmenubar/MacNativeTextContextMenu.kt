...
object MacNativeTextContextMenu {
    ...
    data class MenuAction(val label: String, val systemImageName: String? = null, val enabled: Boolean = true, val action: () -> Unit)
    ...
    internal fun showForTextField(
        ...
        fieldRect: Rect,
        selectAllAction: MenuAction,
        customActions: List<MenuAction>,
...
object NSMenuTextContextMenu : TextContextMenu {
    ...
    internal var customItems: List<MacNativeTextContextMenu.MenuAction> = emptyList()
    ...
    override fun Area(
        ...
        LaunchedEffect(state.status, layoutCoords) {
            ...
            val selectAllAction = MacNativeTextContextMenu.MenuAction(
                label = selectAllText,
...
fun NativeTextContextMenuProvider(
    ...
    customActions: List<MacNativeTextContextMenu.MenuAction> = emptyList(),
    content: @Composable () -> Unit,
) {
    if (hostOs.isMacOS) {
        isDark?.let {
